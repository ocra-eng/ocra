...
export const Hero = () => {
  ...
  return (
    <section className="bg-bog text-chalk">
      <div className="mx-auto flex max-w-[1160px] flex-wrap items-stretch gap-8 px-5 py-14 md:gap-14 md:px-11 md:py-24">
        <div className="flex min-w-0 flex-1 basis-[460px] flex-col justify-center">
          ...
          <p className="mt-5 max-w-[44ch] text-lg text-[#C9D4CB] md:text-[22px] md:leading-relaxed">
            {hero.support}
          </p>
          <p
            lang="ga"
            className="mt-7 font-mono text-[11px] uppercase tracking-[0.22em] text-[#5FBF87]"
          >
            {org.fullNameGa}
          </p>
          <p className="mt-1.5 font-mono text-[11px] uppercase tracking-[0.22em] text-[#7E9B8B]">
            {org.fullName}
          </p>
          <div className="mt-9 flex flex-wrap items-center gap-4">
            ...
            <span className="text-[13px] text-[#7E9B8B]">{hero.ctaNote}</span>
          </div>
        </div>
        <PhotoSlot />
      </div>
