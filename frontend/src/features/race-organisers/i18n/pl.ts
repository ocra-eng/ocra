export const pl = {
  ...
  cards: {
    ...
    standards: {
      title: "Standardy zawodów",
      body: "Standardy trasy, przeszkód i bezpieczeństwa, które muszą spełniać zawody — i dlaczego są ważne.",
    },
    submit: {
      title: "Zgłoś zawody",
      body: "Opowiedz nam o swoich planach i rozpocznij proces sankcjonowania.",
    },
    resources: {
      title: "Materiały dla organizatorów",
      body: "Szablony, listy kontrolne i wskazówki do organizacji sankcjonowanego biegu.",
    },
  },
}
